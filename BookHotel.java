...
public class BookHotel extends JFrame {
	...
	public BookHotel(String username) {
		...
		lusername.setBounds(271, 70, 200, 14);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into bookHotel values('"+lusername.getText()+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+t2.getText()+"', '"+c2.getSelectedItem()+"', '"+c3.getSelectedItem()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+l5.getText()+"')";
                                                                                                        //c 1=choise hotal name t1=kitne person  t2 = days , c3= choice ac or non ac ,c3=choice food yes pr not, l2=id,                                 l3=number,l4=phone,l5=prise                                        
