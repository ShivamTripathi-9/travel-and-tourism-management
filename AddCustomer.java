	...
	public AddCustomer(String username) throws SQLException {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            try{
	    			String uname = t7.getText(); //username
                                String id = (String)comboBox.getSelectedItem(); //ID
	    			String number =  t1.getText();  //Number
	    			String name =  t2.getText(); //Name
                                String gender =  radio; //gender
	    			String cuntry =  t3.getText(); //cuntry
	    			String address =  t5.getText();  //address
                                String phone =  t6.getText(); //phone no
                                String email = t8.getText(); //email
                                
                                String q1 = "insert into customer values('"+uname+"','"+id+"','"+number+"','"+name+"','"+gender
                                               +"','"+cuntry+"','"+address+"','"+phone+"','"+email+"')";
